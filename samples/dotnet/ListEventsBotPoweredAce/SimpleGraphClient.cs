...
namespace ListEventsBotPoweredAce
{
    ...
    public class SimpleGraphClient
    {
        ...
        public async Task<Event[]> GetEventsAsync(int top)
        {
            var graphClient = GetAuthenticatedClient();
            var events = await graphClient.Me.Calendar.Events.GetAsync(a => a.QueryParameters.Top = top);
            return events.Value.ToArray();
        }
